...
// MDES Collaborator Cards Functionality
document.addEventListener('DOMContentLoaded', () => {
    // Modal logic
    ...
    // Handle touch for window as well
    ...
    // Stop propagation on "Details" button
    const detailButtons = document.querySelectorAll('.logo-btn:not(.qr-trigger)');
    detailButtons.forEach(btn => {
        function handleDetailClick(e) {
            e.stopPropagation();
            // You can add logic for the "Details" button here
            console.log("Details button clicked");
        }
        btn.addEventListener('click', handleDetailClick);
        btn.addEventListener('touchstart', handleDetailClick);
    });
    ...
    cols.forEach(col => {
        ...
        // Add both click and touch listeners for flipping
